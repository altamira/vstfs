...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "altamira-bpm-demo";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "altamira-bpm-demo.war")
            ...
            .addPackages(false, "demo") // not recursive to skip package 'nonarquillian'

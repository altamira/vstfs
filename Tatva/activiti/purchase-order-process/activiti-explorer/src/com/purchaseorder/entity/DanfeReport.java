 ...
 * @author PARTH
 * 
 * Entity class for table 'DANFE_REPORT'
 *
 */
@Entity
@Table(name="DANFE_REPORT")
public class DanfeReport 
{
	@Id
	@Column(name="REPORT_ID")
	@SequenceGenerator(name="DanfeReportSequence", sequenceName="DANFE_REPORT_SEQUENCE")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="DanfeReportSequence")

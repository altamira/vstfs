 ...
 * @author PARTH
 * 
 * Entity class for table 'QUOTATION_REPORT'
 *
 */
@Entity
...
public class QuotationReport 
{
	...
	@SequenceGenerator(name="QuotationReportSequence", sequenceName="QUOTATION_REPORT_SEQUENCE")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="QuotationReportSequence")

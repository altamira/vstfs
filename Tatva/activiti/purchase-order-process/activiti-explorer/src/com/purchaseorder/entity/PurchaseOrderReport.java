 ...
 * @author PARTH
 * 
 * Entity class for table 'PURCHASE_ORDER_REPORT'
 *
 */
@Entity
...
public class PurchaseOrderReport 
{
	...
	@SequenceGenerator(name="PurchaseOrderReportSequence", sequenceName="PURCHASE_ORDER_REPORT_SEQUENCE")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="PurchaseOrderReportSequence")

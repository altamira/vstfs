CREATE OR REPLACE DIRECTORY PURCHASEORDER AS 'D:\PURCHASEORDER';

DECLARE

G_ID_SEQ NUMBER;  

JASPER_BFILE BFILE := BFILENAME('PURCHASEORDER', 'purchaseOrder.jasper');
JRXML_BFILE BFILE := BFILENAME('PURCHASEORDER', 'purchaseOrder.jrxml');
LOGO_BFILE BFILE := BFILENAME('PURCHASEORDER', 'logo_altamira.png');
...
INSERT INTO PURCHASE_ORDER_REPORT(REPORT_ID, JASPER_FILE, JRXML_FILE, ALTAMIRA_LOGO)
VALUES (PURCHASE_ORDER_REPORT_SEQUENCE.NEXTVAL, EMPTY_BLOB(), EMPTY_BLOB(), EMPTY_BLOB())
RETURNING REPORT_ID INTO G_ID_SEQ;

SELECT JASPER_FILE, JRXML_FILE, ALTAMIRA_LOGO
INTO JASPER_LOB, JRXML_LOB, LOGO_LOB
FROM PURCHASE_ORDER_REPORT

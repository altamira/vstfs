CREATE OR REPLACE DIRECTORY QUOTATION AS 'D:\QUOTATION';

DECLARE

G_ID_SEQ NUMBER;  

JASPER_BFILE BFILE := BFILENAME('QUOTATION', 'quotation.jasper');
JRXML_BFILE BFILE := BFILENAME('QUOTATION', 'quotation.jrxml');
LOGO_BFILE BFILE := BFILENAME('QUOTATION', 'logo_altamira.png');
...
INSERT INTO QUOTATION_REPORT(REPORT_ID, JASPER_FILE, JRXML_FILE, ALTAMIRA_LOGO)
VALUES (QUOTATION_REPORT_SEQUENCE.NEXTVAL, EMPTY_BLOB(), EMPTY_BLOB(), EMPTY_BLOB())
RETURNING REPORT_ID INTO G_ID_SEQ;

SELECT JASPER_FILE, JRXML_FILE, ALTAMIRA_LOGO
INTO JASPER_LOB, JRXML_LOB, LOGO_LOB
FROM QUOTATION_REPORT

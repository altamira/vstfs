CREATE OR REPLACE DIRECTORY PLANNING AS 'D:\PLANNING';

DECLARE

G_ID_SEQ NUMBER;  

JASPER_BFILE BFILE := BFILENAME('PLANNING', 'PurchasePlanning.jasper');
JRXML_BFILE BFILE := BFILENAME('PLANNING', 'PurchasePlanning.jrxml');
LOGO_BFILE BFILE := BFILENAME('PLANNING', 'logo_altamira.png');
...
INSERT INTO PLANNING_REPORT(REPORT_ID, JASPER_FILE, JRXML_FILE, ALTAMIRA_LOGO)
VALUES (PLANNING_REPORT_SEQUENCE.NEXTVAL, EMPTY_BLOB(), EMPTY_BLOB(), EMPTY_BLOB())
RETURNING REPORT_ID INTO G_ID_SEQ;

SELECT JASPER_FILE, JRXML_FILE, ALTAMIRA_LOGO
INTO JASPER_LOB, JRXML_LOB, LOGO_LOB
FROM PLANNING_REPORT
